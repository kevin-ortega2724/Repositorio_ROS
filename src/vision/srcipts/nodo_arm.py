...
arm_joint_positions5  = [math.radians(90), math.radians(-45), 0.0, math.radians(-45), 0.0, math.radians(90), 0.0]
...
if __name__ == "__main__":
    ...
    arm_client.send_goal(arm_goal) #Enviamos nuestro objetivo hacia el Acción Server de nuestro robot Fetch, esto es un ejemlo
