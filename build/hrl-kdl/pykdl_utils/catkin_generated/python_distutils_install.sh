...
echo_and_run cd "/home/ko/ur_ws/src/hrl-kdl/pykdl_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ko/ur_ws/src/hrl-kdl/pykdl_utils/setup.py" \
     \
    build --build-base "/home/ko/ur_ws/build/hrl-kdl/pykdl_utils" \
    install \
    --root="${DESTDIR-/}" \
